                ...
                <div class="carousel-slide">
                    ...
                    <div class="absolute inset-0 flex items-center justify-center text-white text-center z-10" style="background: rgba(0, 0, 0, 0.4)">
                        <div class="animate-fade-in-up">
                            <h1 class="text-5xl md:text-7xl font-display font-bold mb-4">Summer Collection</h1>
                            <p class="text-xl md:text-2xl mb-8 opacity-90">Discover the latest trends</p>
