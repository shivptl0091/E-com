...
<body>
   <form class="box p-5" action="update_product_photo_service.php" method="POST" enctype="multipart/form-data">
  ...
  <div class="mb-3">
    ...
    <input type="text" name="Varientname" class="form-control" value="<?php echo $row['Varientname']; ?>">
  </div>

 <label for="">Upload Image</label>
    <input type="file" name="image" value="">
    <img src="<?php echo "./photo_Product-media.php/" . $row['photo']; ?>" />
