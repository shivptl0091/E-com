...
<body>
  <form class="box p-5" action="insert_city_service.php" method="POST">
    <!-- <div class="mb-3">
    ...
    <input type="text" name="state_name" class="form-control"  aria-describedby="emailHelp">
  </div> -->

    <div class="mb-3">
      <label for="exampleInputEmail1" class="form-label">City Name</label>
      <input type="text" name="city_name" class="form-control" id="city_name" aria-describedby="emailHelp">
    </div>
