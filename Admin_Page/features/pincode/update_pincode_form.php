...
<body>
  <form class="box p-5" action="update_pincode_service.php" method="POST">
    ...
    <div class="mb-3">
     ...
     <div class="mb-3">
      ...
      <input type="text" name="pincode" class="form-control" aria-describedby="emailHelp" value="<?php echo $row['pincode']; ?>">
    </div>
